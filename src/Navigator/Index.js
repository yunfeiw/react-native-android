...
import SignInScreen from '../Page/SignInScreen/index'
import HomeScreen from '../Page/HomeScreen/index'
import RuleScreen from '../Page/RuleScreen/index'
import HelpScreen from '../Page/HelpScreen/index'
import MyScreen from '../Page/MyScreen/index'
import ManualUpload from '../Page/ManualUpload/index'
// import CourseScreen from '../Page/CourseScreen/index'
...
const AppStack = createBottomTabNavigator({
  ...
  Upload: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({ tintColor }) => {
        return (
          <Ionicons name={"md-cloud-upload"} size={25} color={tintColor} />
        );
      }
    }
  },
